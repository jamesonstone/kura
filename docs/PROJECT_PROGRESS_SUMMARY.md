...
| 0005 | sweep-interactive-failures | `docs/specs/0005-sweep-interactive-failures` | validation | no | 2026-08-24 | Render exact failures, provide retry/exclusion triage, and support bulk STALE retirement with branch preservation. |
...
- **OPEN ITEMS**: approved exact-head installation and hosted validation
