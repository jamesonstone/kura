...
| 0005 | sweep-interactive-failures | `docs/specs/0005-sweep-interactive-failures` | validation | no | 2026-08-24 | Render exact interactive failures, provide safe retry/exclusion triage, and add guarded STALE review. |
