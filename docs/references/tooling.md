...
- Bare sweep failure triage may retry or persist exact reviewed exclusions; it must not repair Git metadata, delete orphan directories, or infer repository identity. The STALE action is only a selector filter and cannot change candidate authority.
